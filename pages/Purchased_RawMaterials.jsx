...
const Purchased_RawMaterials = ({ state }) => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const itemsFromContract = await contract.purchasedRawMaterial();
  ...
  return (
    <GlobalStyles>
      ...
      <Header2 state={state}></Header2>
        <ProductContainer>
          <AvailableMaterialsHeading>Purchased Raw Materials</AvailableMaterialsHeading>
          <ProductList>
...
export default Purchased_RawMaterials;